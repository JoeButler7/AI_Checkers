In this project uses an adversarial state space search to make an AI that plays checkers on both a 4x4 and
...
To compile and run this program simply enter the following commands into the terminal once you are in the folder containing the
source code
javac *.java
java Main
